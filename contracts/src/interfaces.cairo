...
pub trait ILegacyVault<TContractState> {
    ...
    fn get_bridge_treasury(self: @TContractState) -> ContractAddress;
    fn get_admin(self: @TContractState) -> ContractAddress;

    // Admin
    fn set_bridge_treasury(ref self: TContractState, new_treasury: ContractAddress);
    ...
    // Claim / Bridge Trigger (Callable by Beneficiary, Relayer, or Keeper)
